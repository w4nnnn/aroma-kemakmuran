import { getActiveProductBySlug } from "@/lib/actions/products";
...
export default async function ProductPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const product = await getActiveProductBySlug(resolvedParams.slug);
  if (!product) notFound();

  const isPhysicalProduct = !!product.shopeeUrl;
